...
class OzetUcurtmaAvcisi extends StatefulWidget {
  @override
  _OzetUcurtmaAvcisiState createState() => _OzetUcurtmaAvcisiState();
}
class _OzetUcurtmaAvcisiState extends State<OzetUcurtmaAvcisi> {
  @override
